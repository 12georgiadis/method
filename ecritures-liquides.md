...
This is the opposite of generating fictional worlds from scratch. The latent space of a diffusion model contains the entire history of human representation -- every photograph, every painting, every frame ever digitized. When you feed a documentary image into that space, it doesn't disappear. It encounters everything else. The result is a chimera: part document, part hallucination, part collective memory.
